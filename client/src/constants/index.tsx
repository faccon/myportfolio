...
export const SPECIALIZATION = 'Full Stack Developer';
export const FIELDS = 'Website, Mobile and Cloud developer';
export const ABOUT_ME = 'I am a full stack developer. I develop cloud native web applications, mobile applications and also automate tasks with python';
...
export const RESUME_LINK = 'https://drive.google.com/file/d/1R3R26ArEsJih8fUxngbEkzwTsOMHMqBE/view?usp=sharing'
